...
public class ChiperUtils {
    ...
    private static final Logger log = Logger.getLogger(ChiperUtils.class.getName());
    ...
    public static String decrypt(String secretKey, String encryptedText) throws SIDClientException {
